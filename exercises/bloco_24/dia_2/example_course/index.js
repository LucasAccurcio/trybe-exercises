...
app.get('/usersbooks/:id', async (req, res) => {
  try {
    ...
    // A propriedade "through" vazia faz desaparecer nos resultados a tabela de ligação no caso "UserBooks"
  //   "UserBook": {
  //     "book_id": 1,
  //     "user_id": 2
  // }
...
// ** TRANSACTION - ONDE TODAS AS SOLICITAÇÕES PRECISAM SER EXECUTADADAS OU DÁ ERRO E É TUDO RETORNADO COMO ERA ANTES
