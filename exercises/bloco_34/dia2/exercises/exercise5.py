# Exercício 5: Você tem a implementação de uma classe capaz renderizar imagens através
# de uma interface que utiliza o método draw. Porém, no momento ela só suporta formato
# PNG e você também precisa ser capaz de renderizar imagens em SVG. Altere o código,
...
# Testes de mesa:
png = PngImage(".tela.png")
png.draw()

svg = SvgImageAdapter(SvgImage(".mysql.svg"))
svg.draw()