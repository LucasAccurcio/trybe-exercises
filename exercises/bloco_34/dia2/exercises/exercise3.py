# Exercício 3: Com o baralho tradicional pronto, implemente agora uma subclasse de Baralho
# chamada BaralhoInverso, que produz um iterador para fornecer as cartas na ordem inversa,
# ou seja, sem embaralhar, a primeira carta deve ser o <K de paus> em vez do <A de copas>,
...
class IteradorDoBaralhoInverso(Iterator):
    def __init__(self, cartas):
        self._cartas = cartas
        self._pos = -1  # -1 para iniciar da última posição
