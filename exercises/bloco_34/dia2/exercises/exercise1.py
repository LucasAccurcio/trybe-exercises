# Exercício 1: Abaixo temos parte da implementação de um jogo do mundo de Star Wars.
...
# StarWarsGame(Jedi(20)).fight_enemy()  # Não iria funcionar pois a Classe Jedi não possui o método attack
StarWarsGame(JediAdapter(Jedi(20))).fight_enemy() # Solução