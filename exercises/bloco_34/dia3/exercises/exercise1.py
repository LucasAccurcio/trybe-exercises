...
log = Log()
print(LogError(log).dispara_log("Sistema travando."))
print(LogWarning(log).dispara_log("Sistema com lentidão."))
print(LogSuccess(log).dispara_log("Sistema funcionando normalmente."))
